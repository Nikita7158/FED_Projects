            ...
            >
              ...
              <div className="w-4/5 mx-auto text-left py-4">
                ...
                <div className="my-4 flex items-center gap-4">
                  ...
                  />
                  <p className="text-sm">
                    Share my registration data with jio savaan's content providers
                ...
                <p className="my-4 text-xs">
                  ...
                  <Link to="/" className="text-green-400">
                    jio savaan's Terms and Condition
                  </Link>{" "}
                  of Use.
                </p>
                <p className="my-4 text-xs">
                  To learn more about how jio savaan collects, uses, shares and
                  protects your personal data, please see
                  <Link to="/" className="text-green-400">
                    jio savaan's Privacy Policy.
                  </Link>{" "}
                </p>
              </div>
